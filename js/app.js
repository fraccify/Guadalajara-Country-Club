...
formulario.addEventListener("submit", (e) => {
    ...
    if ((usuarioInput === "CENTINELA" && contraseñaInput === "Mh6789qr") || (usuarioInput === "AGCH" && contraseñaInput === "Mh6789qr")) {
        ...
        function obtenerYAgregarRegistros2() {
            ...
            fetch("https://sheet.best/api/sheets/3970b5ca-34e4-4982-8048-f3735d8615bf/tabs/visitas")
                ...
                .then((data) => {
                    ...
                    agregarRegistros("alba-registrosss", registrosHoy.filter((registro) => registro.domicilio.startsWith("IkVzcGHDsW")));
                    agregarRegistros("caballeros-registrosss", registrosHoy.filter((registro) => registro.domicilio.startsWith("Ikd1YWRpYW5h")));
                    agregarRegistros("esmeralda-registrosss", registrosHoy.filter((registro) => registro.domicilio.startsWith("IlRpYmVy")));
                    agregarRegistros("eros-registrosss", registrosHoy.filter((registro) => registro.domicilio.startsWith("IkFyZ2VudGluY")));
        ...
        fetch("https://sheet.best/api/sheets/3970b5ca-34e4-4982-8048-f3735d8615bf/tabs/propietarios")
            //actualización
            .then((response) => response.json())
            .then((data) => {
                ...
                if (aceptoAvisoPrivacidad2) {
                    if (indice !== -1) {
                        ...
                        if (contraseñaCifrada === contraseñaCifradoInput) {
                            ...
                            const urlregistro = "https://sheet.best/api/sheets/3970b5ca-34e4-4982-8048-f3735d8615bf/tabs/registros";
                            const opciones = {
                                method: "POST",
                                headers: {
                            ...
                            function registrarReserva() {
                                ...
                                if (statuscod === "Al Corriente") {
                                    ...
                                    const url = "https://sheet.best/api/sheets/3970b5ca-34e4-4982-8048-f3735d8615bf/tabs/reservaciones";
                                    const opciones = {
                                        method: "POST",
                                        headers: {
                                            "Content-Type": "application/json"
                            ...
                            function toggleMisReservas() {
                                ...
                                const domicilio = domicilioSpan.textContent;
                                fetch("https://sheet.best/api/sheets/3970b5ca-34e4-4982-8048-f3735d8615bf/tabs/reservaciones")
                                    .then((response) => response.json())
                                    .then((data) => {
                                        console.log(domiciliocod);
                            ...
                            function eliminarreservacion(amenidad, fecha, domiciliocod) {
                                ...
                                const apiURL = "https://sheet.best/api/sheets/3970b5ca-34e4-4982-8048-f3735d8615bf/tabs/reservaciones";
                            ...
                            function calendario(){
                                ...
                                calendarioIframe.setAttribute("src", "https://calendar.google.com/calendar/embed?src=c771e3155f0d82b3095b10c292be03d82b34adda7e3e19750b9227452d423079%40group.calendar.google.com&ctz=America%2FMexico_City");
                            ...
                            function confirmacionvyp() {
                                ...
                                const url = "https://sheet.best/api/sheets/3970b5ca-34e4-4982-8048-f3735d8615bf/tabs/visitas";
                            ...
                            function enviardatospago() { 
                                ...
                                const urlVerificacion = `https://sheet.best/api/sheets/3970b5ca-34e4-4982-8048-f3735d8615bf/tabs/pagos/clavederastreo/${encodeURIComponent(clavederastreoSpan)}`;
                                ...
                                function enviarDatos() {
                                    ...
                                    const url = "https://sheet.best/api/sheets/3970b5ca-34e4-4982-8048-f3735d8615bf/tabs/pagos";
                                    const opciones = {
                                        method: "POST",
                                        headers: {
                                            "Content-Type": "application/json"
...
document.getElementById("inicarsesionadmin").addEventListener("click", () => {
    ...
    fetch("https://sheet.best/api/sheets/3970b5ca-34e4-4982-8048-f3735d8615bf/tabs/admin")
        .then((response) => response.json())
        .then((data) => {
            const correoCifradoInput = cifrarCorreo(usuarioInput);
            const correosCifrados = data.map((fila) => fila.correo);
            ...
            if (indice !== -1) {
                ...
                if (contraseñaCifrada === contraseñaCifradoInput) {
                    ...
                    .then((data) => {
                        ...
                        generarTabla("alba-registros", data.filter((registro) => registro.dom.startsWith("IkVzcGHDsW")));
                        generarTabla("caballeros-registros", data.filter((registro) => registro.dom.startsWith("Ikd1YWRpYW5h")));
                        generarTabla("esmeralda-registros", data.filter((registro) => registro.dom.startsWith("IlRpYmVy")));
                        generarTabla("eros-registros", data.filter((registro) => registro.dom.startsWith("IkFyZ2VudGluY")));
    ...
    if (sesionIniciada) {
        ...
        fetch("https://sheet.best/api/sheets/3970b5ca-34e4-4982-8048-f3735d8615bf/tabs/propietarios")
            ...
            .then((data) => {
                ...
                const url = `https://sheet.best/api/sheets/3970b5ca-34e4-4982-8048-f3735d8615bf/tabs/propietarios/${indice}`;
                console.log("URL:", url);
...
function agregarresidente () {
    ...
    if (sesionIniciada){
        ...
        const urlVerificacion = `https://sheet.best/api/sheets/3970b5ca-34e4-4982-8048-f3735d8615bf/tabs/propietarios/dom/${(domcif)}`;
        console.log(urlVerificacion);
        ...
        .then((data) => {
            ...
            if (data.length < 1) {
                ...
                const url = "https://sheet.best/api/sheets/3970b5ca-34e4-4982-8048-f3735d8615bf/tabs/propietarios";
